...
\begin{tikzpicture}
 ...
 \begin{class}[text width = 8cm]{LinkedList}{21, 0}
 ...
 \begin{class}[text width = 8cm]{FileException}{21, -9}
 ...
 \begin{class}[text width = 15cm]{Database}{34,0}
 ...
 \begin{class}[text width = 8cm]{UserInterface}{21, -13}
